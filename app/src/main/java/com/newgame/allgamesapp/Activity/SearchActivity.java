...
import com.newgame.allgamesapp.Adapter.SeachAdapter;
...
public class SearchActivity extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Gamelist = getItems();
        adapter = new SeachAdapter(Gamelist,getApplicationContext());
...
/// sp
    ...
    private void initViews(){
        rvLista = findViewById(R.id.rvListaf);
        svSearch = findViewById(R.id.svSearchf);
    }
    @Override
